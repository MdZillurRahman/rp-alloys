...
const SecondSection = () => {
  return (
    <>
    <div className="bg-[#F7F7F7] relative py-3 h-[300px] lg:py-10 lg:h-[700px] 2xl:py-10 2xl:h-[700px]" >
      <img
    ...
    <div className="mt-[-30px] lg:mt-[-300px] 2xl:mt-[-300px] my-2 lg:my-10 2xl:my-10">
        ...
        <div className="relative my-4 lg:mr-8 2xl:mr-8 group">
          ...
          <div
            ...
            className="absolute bottom-0 px-4 py-[-2] text-white h-[120px] block lg:hidden 2xl:hidden group-hover:block "
          >
